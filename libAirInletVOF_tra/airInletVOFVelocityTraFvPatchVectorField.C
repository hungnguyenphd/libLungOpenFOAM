...
#include "airInletVOFVelocityTraFvPatchVectorField.H"
...
airInletVOFVelocityTraFvPatchVectorField
(
    const airInletVOFVelocityTraFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::airInletVOFVelocityTraFvPatchVectorField::setWallDist()
{
...
// Foam::airInletVOFVelocityTraFvPatchVectorField::profile()
// {
//     if (profile_.valid())
//     {
...
void Foam::airInletVOFVelocityTraFvPatchVectorField::updateValues
(
    const RhoType& rho
)
{
    ...
    const List<double> flowrate_data_Ls_ori{0.00000000e+00, 1.37186674e-02, 6.46436522e-02, 1.55465159e-01,
...
void Foam::airInletVOFVelocityTraFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::airInletVOFVelocityTraFvPatchVectorField::write(Ostream& os) const
{
